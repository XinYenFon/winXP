...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
		<div class="window">
			<div class="title-bar', $category['is_collapsed'] ? ' collapsed' : '', '" id="category_', $category['id'], '">
				<div class="title-bar-text">
					' . $category['link'] . '<br>
					', !empty($category['description']) ? '<span class="smalltext">' . $category['description'] . '</span>' : '', '
				</div>';
		...
		echo '
			...
			<div id="category_', $category['id'], '_boards" class="window-body ', (!empty($category['css_class']) ? ('' . $category['css_class'] . '') : ''), '">';
	...
	if ($context['user']['is_logged'] && !empty($context['categories']))
		echo '
	<div class="mark_read righttext">
		', template_button_strip($context['mark_read_button']), '
	</div>';
}
