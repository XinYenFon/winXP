...
function template_main()
{
	...
	echo '
	<div id="topic_cont" class="window">
		<div class="title-bar">
	...
	echo '
		<form action="', $scripturl, '?action=quickmod2;topic=', $context['current_topic'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" onsubmit="return oQuickModify.bInEditMode ? oQuickModify.modifySave(\'' . $context['session_id'] . '\', \'' . $context['session_var'] . '\') : false" class="window-body">';
...
function template_quickreply()
{
	...
	echo '
		...
		<div class="window" id="quickreply">
			<div class="title-bar">
				<div class="title-bar-text">
					', $txt['quick_reply'], '
				</div>
			</div>
			<div id="quickreply_options" class="window-body">';
